...
class PlateDataset(preprocess.SegmentationDataset):

    def __init__(self, dataset_dir, subset,class_ids=None,
                 class_map=None, return_coco=False, **kwargs):
        """
        ...
        self.load_coco(dataset_dir=dataset_dir, subset=subset,class_ids=class_ids,
                       class_map=class_map, return_coco=return_coco)
        self.prepare()
    ...
    def create_mask(self, image, image_id):
        ...
        if image_info["source"] != "coco":
            return super(PlateDataset, self).create_mask(image, image_id)
        ...
        if class_ids:
            ...
            return super(PlateDataset, self).create_mask(image_id)
    ...
    def image_reference(self, image_id):
        ...
        if info["source"] == "coco":
            ...
            super(PlateDataset, self).image_reference(image_id)
